    ...
    <div class="inline_page" id="page_268">
        ...
        <?php   $args = array('post_type' => 'page', 
                ...
                if (get_post_type( get_the_ID() ) == 'page') {
                        echo '<div class="inline_page ' . basename(get_permalink()) .' " id="page_' . get_the_ID() . '"><div id="page_title"><h1>' . get_the_title() . '<h1></div><div id="page_content">' . do_shortcode(get_post_field('post_content', $postid)) . '</div></div>';
                }
                endwhile; ?>
        </div><!-- #content -->
    </div><!-- #primary -->
